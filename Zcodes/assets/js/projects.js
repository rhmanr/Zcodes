document.addEventListener('DOMContentLoaded', function() {
    const projects = [
        ...
        },
        {
            ...
            description: 'Custom deep learning framework built from scratch to understand the underlying mechanics of neural networks.',
            image: 'assets/images/projects/deep-learning.jpg',
            tags: ['Deep Learning', 'Neural Networks', 'Python'],
            links: [
                { url: 'projects/deep-learning.html', text: 'View Details' },
                { url: '#', text: 'GitHub' }
            ]
        }
    ];
